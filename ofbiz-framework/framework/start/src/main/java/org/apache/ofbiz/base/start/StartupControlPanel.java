...
final class StartupControlPanel {
    ...
    static void start(Config config, AtomicReference<ServerState> serverState, List<StartupCommand> ofbizCommands,
        ...
        if (config.isShutdownAfterLoad()) {
            ...
            System.out.println(ls + "  .oooooo.    ooooo     ooo ooooooooo.   ooooo     ooo     ____  __________  _" + ls
                                  + " d8P'         `888'     `8' `888   `Y88. `888'     `8'    / __ \\/ ____/ __ )(_)___" + ls
                                  + "888    ooooo   888       8   888ooo88P'   888       8    / / / / /_  / __  / /_  /" + ls
                                  + "`88.    .88'   `88.    .8'   888  `88b.   `88.    .8'   / /_/ / __/ / /_/ / / / /_" + ls
                                  + " `Y8bood8P'      `YbodP'    o888o  o888o    `YbodP'     \\____/_/   /_____/_/ /___/  is started and ready." + ls);
        }
    }
